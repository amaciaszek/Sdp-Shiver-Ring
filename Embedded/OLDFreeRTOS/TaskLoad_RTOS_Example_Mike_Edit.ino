//**************************************************************************
// FreeRtos on Samd51
// By Scott Briscoe, edited by Michael Burton
//
...
static void threadA( void *pvParameters ) 
{
  ...
  {
    SERIAL.print("S");
    myDelayMs(1500); // short delay (to do periodically)
  }
...
static void threadB( void *pvParameters ) 
{
  ...
  {
    SERIAL.println("L");
    myDelayMs(10000); // long delay, could be used to detect shiver events
  }
